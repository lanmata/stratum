  ...
  template: `
    <div class="min-h-screen bg-gray-50 p-6">
      <div class="mb-6">
        ...
        <h1 class="mt-1 text-xl font-semibold text-gray-900">Features</h1>
      </div>
            ...
            <tbody class="divide-y divide-gray-100">
              @for (feature of features(); track feature.id) {
                <tr class="hover:bg-gray-50">
                  ...
                  <td class="px-4 py-3 text-gray-600">{{ feature.description }}</td>
                  <td class="px-4 py-3">
                    <span
                      class="rounded-full px-2 py-0.5 text-xs font-medium"
                      [class]="feature.active ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'"
                    >
                ...
                <tr>
                  <td colspan="3" class="px-4 py-8 text-center text-gray-400">No features found</td>
                </tr>
              }
            </tbody>
          </table>
